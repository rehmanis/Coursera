...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		// if the last element is a word, then increment the numSentences since
		// the last sentence may not have a punctuation
		if (!tokens.isEmpty()  && this.isWord(tokens.get(tokens.size() - 1))) {
			this.numSentences += 1;
		}
